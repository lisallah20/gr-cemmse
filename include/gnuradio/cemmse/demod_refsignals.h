...
#ifndef INCLUDED_CEMMSE_DEMOD_REFSIGNALS_H
#define INCLUDED_CEMMSE_DEMOD_REFSIGNALS_H
 ...
 * complex(real(float), imag(float)).
 */
class CEMMSE_API demod_refsignals : virtual public gr::block
{
public:
    typedef std::shared_ptr<demod_refsignals> sptr;
...
#endif /* INCLUDED_CEMMSE_DEMOD_REFSIGNALS_H */
