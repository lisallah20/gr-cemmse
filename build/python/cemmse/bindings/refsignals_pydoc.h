...
#define D(...) DOC(gr,cemmse, __VA_ARGS__ )
/*
 ...
 */
 ...
 static const char *__doc_gr_cemmse_refsignals = R"doc(Reference signals generator.
...
Args:
    ...
    cell_id : value of the CTo solve the problem, we need to include the header file that declares the ref_signals_impl class.ell ID.)doc";


 static const char *__doc_gr_cemmse_refsignals_refsignals = R"doc()doc";


 static const char *__doc_gr_cemmse_refsignals_make = R"doc(Reference signals generator.
